...
CREATE TABLE Avis(
        ...
        Date           Date NOT NULL ,
        Avis           Text NOT NULL
	,CONSTRAINT Avis_PK PRIMARY KEY (identifiant_id)
)ENGINE=InnoDB;
...
CREATE TABLE Interagit(
	...
	,CONSTRAINT Interagit_PK PRIMARY KEY (Identifiant,Offre_id,identifiant_id)

	,CONSTRAINT Interagit_Utilisateur_FK FOREIGN KEY (Identifiant) REFERENCES Utilisateur(Identifiant)
	,CONSTRAINT Interagit_Offre0_FK FOREIGN KEY (Offre_id) REFERENCES Offre(Offre_id)
	,CONSTRAINT Interagit_Avis1_FK FOREIGN KEY (identifiant_id) REFERENCES Avis(identifiant_id)
)ENGINE=InnoDB;
